...
values can use \texttt{put\_unindexed}; they remain addressable by primary key
...
property-granular merge by layout---while leaving distributed index repair and
a production document model as future work.
