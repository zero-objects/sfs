...
in-memory or origin-private backend.  Cloud synchronization converts local
...
WNFS and Peergos combine encrypted, portable, collaborative
...
describe the artifact and evaluation.  \Cref{sec:related,sec:discussion}
